function R=f(t,y,p,Omega,force)
%last edited 22/12/20
% keyboard
...
ki_z7*y(18);%14
d_x6*y(6);%15
%V_1max*( (1+a*((y(1)/k_t1)^b))/( 1+(((y(2)+y(3))/k_i1)^c)*((y(1)/k_t1)^b)+((y(1)/k_t1)^b) ));%16 NONLINEAR
(V_1max*Omega)*( (1+a*((y(1)/(k_t1*Omega))^b))/( 1+(((y(2)+y(3))/(k_i1*Omega))^c)*((y(1)/(k_t1*Omega))^b)+((y(1)/(k_t1*Omega))^b) ));%16 NONLINEAR
d_y1*y(7);%17
%V_2max*( (1+d*((y(1)/k_t2)^e))/( 1+(((y(2)+y(3))/k_i2)^f)*((y(1)/k_t2)^e)+((y(1)/k_t2)^e) ))*(1/(1+((y(5)/k_i21)^f1)));%18 NONLINEAR
(V_2max*Omega)*( (1+d*((y(1)/(k_t2*Omega))^e))/( 1+(((y(2)+y(3))/(k_i2*Omega))^f)*((y(1)/(k_t2*Omega))^e)+((y(1)/(k_t2*Omega))^e) ))*(1/(1+((y(5)/(k_i21*Omega))^f1)));%18 NONLINEAR
d_y2*y(8);%19
%V_3max*( (1+g*((y(1)/k_t3)^v))/( 1+(((y(2)+y(3))/k_i3)^w)*((y(1)/k_t3)^v)+((y(1)/k_t3)^v)));%20 NONLINEAR
(V_3max*Omega)*( (1+g*((y(1)/k_t3*Omega)^v))/( 1+(((y(2)+y(3))/k_i3*Omega)^w)*((y(1)/k_t3*Omega)^v)+((y(1)/k_t3*Omega)^v)));%20 NONLINEAR
d_y3*y(9);%21
%V_4max*( (1+h*((y(1)/k_t4)^p))/( 1+(((y(2)+y(3))/k_i4)^q)*((y(1)/k_t4)^p)+((y(1)/k_t4)^p) ));%22 NONLINEAR
(V_4max*Omega)*( (1+h*((y(1)/k_t4*Omega)^p1))/( 1+(((y(2)+y(3))/(k_i4*Omega))^q)*((y(1)/(k_t4*Omega))^p1)+((y(1)/(k_t4*Omega))^p1) ));%22 NONLINEAR
d_y4*y(10);%23
%V_5max*( (1+i*((y(6)/k_t5)^n))/( 1+(((y(5)/k_i5)^m)+(y(6)/k_t5)^n)));%24 NONLINEAR
(V_5max*Omega)*( (1+i11*((y(6)/(k_t5*Omega))^n))/( 1+(((y(5)/(k_i5*Omega))^m)+(y(6)/(k_t5*Omega))^n)));%24 NONLINEAR
d_y5*y(11);%25
k_p2*(y(8)+y_20);%26 
kd_z4*y(15);%27
kd_z5*y(16);%28
%kf_z5*y(12)*y(13);%29 
(kf_z5/Omega)*y(12)*y(13)
%kf_z4*y(12)*y(14);%30 NONLINEAR
(kf_z4/Omega)*y(12)*y(14);%30 
d_z1*y(12);%31
k_p1*(y(7)+y_10);%32 
kd_phz3*y(14)%33
kph_z2*y(13);%34
